!function (a, b) {
  ...
  return function (a) {
    ...
    d = [c(3), c(4), c(1), c(2)], void 0 !== (e = function (a, b, c, d) {
      ...
      var i = !c.isUndefined(window.PointerEvent), j = !i && d.isMobile(), k = !i && !j, l = d.isFF() && d.isOSX(),
        m = function (a, j) {
          function m(a) {
    ...
    d = [c(2), c(1), c(4), c(7), c(120), c(26), c(3)], void 0 !== (e = function (a, b, c, d, e, f, g) {
      ...
      function j(j, k) {
        ...
        var q, r, s, t = null, u = -1, v = !1, w = -1, x = null, y = -1, z = null, A = !0, B = !1, C = null, D = this,
          E = function () {
            return r && r.__ready
          }, F = function () {
          ...
          init: function (a) {
            ...
            if (q !== e) {
              ...
              var f = [c.JWPLAYER_MEDIA_META, c.JWPLAYER_MEDIA_ERROR, c.JWPLAYER_MEDIA_SEEK, c.JWPLAYER_MEDIA_SEEKED, "subtitlesTracks", "subtitlesTrackChanged", "subtitlesTrackData", "mediaType"],
                h = [c.JWPLAYER_MEDIA_BUFFER, c.JWPLAYER_MEDIA_TIME], j = [c.JWPLAYER_MEDIA_BUFFER_FULL];
    ...
    d = [c(15), c(2), c(27), c(1), c(4), c(7), c(26), c(3), c(61)], void 0 !== (e = function (a, b, c, d, e, f, g, h, i) {
      ...
      function m(m, x) {
        ...
        var na, oa, pa, qa, ra, sa = this, ta = {
          ...
          }, ua = !1, va = 0, wa = -1, xa = -1, ya = !0, za = -1, Aa = null, Ba = !!x.sdkplatform, Ca = !1, Da = !1,
          Ea = null, Fa = -1, Ga = -1, Ha = null, Ia = {level: {}}, Ja = null, Ka = null,
        ...
        Ma = Ma || document.createElement("video"), Ma.className = "jw-video jw-reset", this.isSDK = Ba, this.itemTracks = Ha, this.video = Ma, d.isObject(x.cast) && x.cast.appid && Ma.setAttribute("disableRemotePlayback", ""), j(ta, Ma), u || (Ma.controls = !0, Ma.controls = !1), Ma.setAttribute("disableRemotePlayback", ""), Ma.setAttribute("x-webkit-airplay", "allow"), Ma.setAttribute("webkit-playsinline", ""), Ma.setAttribute("playsinline", ""), Ma.setAttribute("x5-playsinline", ""), Ma.setAttribute("x5-video-player-type", "h5"), Ma.setAttribute("x5-video-player-fullscreen", "true"), this.stop = function () {
          ...
          var c = {hasAudio: !0, hasVideo: !0, isLive: Ka.isLive, type: "flv", url: ra[za].file, withCredentials: !1};
          ...
          b = !!b, b || t ? a.style(na, {visibility: "visible", opacity: 1}) : a.style(na, {visibility: "", opacity: 0})
    ...
    d = [c(1)], void 0 !== (e = function (a) {
      var b = {},
        c = {TIT2: "title", TT2: "title", WXXX: "url", TPE1: "artist", TP1: "artist", TALB: "album", TAL: "album"};
            ...
            if (l > 0) {
              ...
              if ("PRIV" === e.value.key) {
                if ("com.apple.streaming.transportStreamTimestamp" === n) {
                  var o = 1 & b.syncSafeInt(g.subarray(j, j += 4)), p = b.syncSafeInt(g.subarray(j, j += 4));
    ...
    d = [c(84), c(83), c(4), c(7), c(2), c(3), c(1)], void 0 !== (e = function (a, b, c, d, e, f, g) {
      ...
      var i = {skipoffset: null, tag: null}, j = function (a, b, f) {
        ...
        this.type = "instream", this.init = function () {
          ...
          if (e.isAndroid(2.3)) return void this.trigger({type: c.JWPLAYER_ERROR, message: "流加载失败：在Android 2.3上不能加载流"});
    ...
    d = [c(20), c(34), c(57), c(41), c(21), c(1), c(2), c(4), c(8), c(16)], void 0 !== (e = function (a, b, d, e, f, g, h, i, j, k) {
      function l() {
        return {
          ...
          LOADED_POLYFILLS: {method: u, depends: ["LOAD_PROMISE_POLYFILL", "LOAD_BASE64_POLYFILL", "LOAD_JSON2"]},
          ...
          switch (f(j).toLowerCase()) {
            case"content":
              if (e(j, "duration") && (b.duration = c.seconds(e(j, "duration"))), e(j, "url")) {
                b.sources || (b.sources = []);
                var n = {file: e(j, "url"), type: e(j, "type"), width: e(j, "width"), label: e(j, "label")}, o = d(j);
    ...
    d = [c(63), c(16), c(62)], void 0 !== (e = function (a, b) {
      ...
      var h, i, j, k, l = {}, m = document.getElementsByTagName("script")[0].parentNode,
        n = "https://drm.media.baidubce.com:8888/v1/sdk-player", o = 0, p = 0, q = !1, r = (new Date).getTime() + "",
        s = !1;
      return function (a, b) {
        ...
        a.on("meta", function (a) {
          ...
          }, 6e4), f = {action: "/user/web/count", session: r, url: h.get("file") || h.getCurrentItem().file}, g(f))))
    ...
    d = [c(15), c(2), c(27), c(1), c(4), c(7), c(26), c(3), c(61)], void 0 !== (e = function (a, b, c, d, e, f, g, h, i) {
      ...
      function l(l, u) {
        ...
        var ja, ka, la, ma, na, oa = this, pa = {
          ...
          }, qa = !1, ra = 0, sa = -1, ta = -1, ua = !0, va = -1, wa = !!u.sdkplatform, xa = !1, ya = !1, za = null,
          Aa = -1, Ba = -1, Ca = null, Da = {level: {}}, Ea = document.getElementById(l),
        ...
        this.isSDK = wa, this.itemTracks = Ca, this.video = Fa, d.isObject(u.cast) && u.cast.appid && Fa.setAttribute("disableRemotePlayback", ""), j(pa, Fa), Fa.controls = !0, Fa.controls = !1, Fa.setAttribute("disableRemotePlayback", ""), Fa.setAttribute("x-webkit-airplay", "allow"), Fa.setAttribute("webkit-playsinline", ""), Fa.setAttribute("playsinline", ""), Fa.setAttribute("x5-playsinline", ""), this.stop = function () {
          ...
          b = !!b, b ? a.style(ja, {visibility: "visible", opacity: 1}) : a.style(ja, {visibility: "", opacity: 0})
        }, this.resize = function (b, c, d) {
    ...
    d = [c(166), c(2), c(1), c(9), c(15)], void 0 !== (e = function (a, b, c, d, e) {
      ...
      return c.extend(f.prototype, {
        setup: function () {
          ...
          if (d && d[a] && d[a].image) {
            var f = d[a].image, g = b.getElementsByClassName("jw-media", this.api.getContainer())[0], h = this,
            ...
            if (c.isString(f) ? (f = encodeURI(f), i.backgroundImage = 'url("' + f + '")') : i.backgroundImage = "", "end" === a && (i["z-index"] = 0), "pause" === a) {
              var j = g ? g.clientHeight : this.model.get("height"), k = g ? g.clientWidth : this.model.get("width");
      ...
      return function (g) {
        ...
        r = document.createElement("div"), r.className = "jw-captions jw-reset", this.show = function () {
          ...
          if (s = document.createElement("div"), t = document.createElement("span"), s.className = "jw-captions-window jw-reset", t.className = "jw-captions-text jw-reset", u = d.extend({}, f, c), c) {
            var h = u.fontOpacity, i = u.windowOpacity, j = u.edgeStyle, k = u.backgroundColor, l = {}, o = {
      ...
      return {
        loadThumbnails: function (a) {
          ...
          var c = this.chooseThumbnail(b),
            d = {display: "block", margin: "0 auto", backgroundPosition: "0 0", backgroundRepeat: "no-repeat"};
    ...
    d = [c(1), c(2), c(21), c(43), c(22), c(130), c(134)], void 0 !== (e = function (a, b, c, d, e, f, g) {
      var h = e.extend({
        ...
        constructor: function (b, c) {
          ...
          if (0 !== d) {
            var e = b.bounds(this.elementRail), f = document.documentElement.scrollLeft || document.body.scrollLeft,
        ...
        return d.extend(this, e), this.setup = function (e) {
          if (k = d.extend({}, h, m), k.hide = "true" === k.hide.toString(), j = b.createElement(f()), k.file) {
            k.hide && b.addClass(j, "jw-hide"), b.addClass(j, "jw-logo-" + (k.position || h.position)), "top-right" === k.position && (i.on("change:dock", this.topRight, this), i.on("change:controls", this.topRight, this), this.topRight(i)), i.set("logo", k), l.onload = function () {
              var a = {backgroundImage: 'url("' + this.src + '")', width: this.width, height: this.height};
    ...
    d = [c(2), c(175), c(1), c(9), c(16)], void 0 !== (e = function (a, b, c, d, e) {
      ...
      return c.extend(f.prototype, {
        buildArray: function () {
          ...
          if (a.isIE() && (a.hasClass(c, "jw-video") || a.hasClass(c, "jw-warning"))) return {x: d, y: e + 40};
    ...
    d = [c(1), c(2)], void 0 !== (e = function (a, b) {
      ...
      return a.extend(c.prototype, {
        hide: function () {
          ...
          var c = {paddingLeft: 0, paddingRight: 0}, d = a.get("controls"), e = a.get("dock"), f = a.get("logo");
          if (f) {
    ...
    d = [c(2), c(4), c(3), c(21), c(7), c(128), c(129), c(138), c(139), c(141), c(137), c(143), c(127), c(142), c(144), c(145), c(1), c(172)], void 0 !== (e = function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
      ...
      return function (w, x) {
        ...
        var la, ma, na, oa, pa, qa, ra, sa, ta, ua, va, wa, xa, ya, za, Aa, Ba, Ca, Da, Ea, Fa, Ga = -1, Ha = 2e3,
          Ia = 40, Ja = !1, Ka = !1, La = -1, Ma = -1, Na = !1, Oa = !1, Pa = q.extend(this, c);
    ...
    var f = c(153), g = d(f), h = c(154), i = d(h), j = c(155), k = d(j), l = c(156), m = d(l), n = c(157), o = d(n),
      p = c(158), q = d(p), r = c(159), s = d(r)
  }, function (a, b, c) {
    "use strict";
    b.__esModule = !0;
    var d = c(13);
